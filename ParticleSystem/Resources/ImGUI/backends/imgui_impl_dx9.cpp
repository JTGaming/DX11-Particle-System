...
static void ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data)
{
    ...
    // Being agnostic of whether <d3dx9.h> or <DirectXMath.h> can be used, we aren't relying on D3DXMatrixIdentity()/D3DXMatrixOrthoOffCenterLH() or XMMatrixIdentity()/XMMatrixOrthographicOffCenterLH()
    {
